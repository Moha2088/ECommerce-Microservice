...
namespace Ordering.Applicaton.Orders.Commands.CreateOrder
{
    public class CreateOrderHandler(IApplicationDbContext context) : ICommandHandler<CreateOrderCommand, CreateOrderResult>
    {
        ...
        public Order CreateNewOrder(OrderDto orderDto)
        {
            ...
            orderDto.OrderItems.ForEach(orderItemDto => newOrder.Add(ProductId.Of(orderItemDto.ProductId), orderItemDto.Quantity, orderItemDto.Price));
            return newOrder;
        }
    }
}